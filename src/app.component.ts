...
export class AppComponent {
  ...
  public nodeDefaults(node: NodeModel): NodeModel {
    ...
    node.height = 70;
    node.annotations = [
      { content: (node.data as EmployeeInfo).Name, style: { color: 'black' }, verticalAlignment: 'Bottom'  },
      { content: (node.data as EmployeeInfo).Role, style: { color: 'black' }, verticalAlignment: 'Top' },
    ];
    return node;
  }
